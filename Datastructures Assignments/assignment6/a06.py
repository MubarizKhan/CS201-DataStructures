...
def find_val(self, val): 
    ...
    #----------------------------------------------
    # if self.left:
    #     left_child = self.left.find_val(val)
    #     else:
    #         left_child = None
    # if self.right:
    #     right_child = self.right.find_val(val)
    #     else:
    #         right_child = None
...
def find_nemo(self, name):
    ...
    if self.val.name == name:
        ...
        if self.left:
            ...
            if self.left.find_nemo(name):           
                return self.left.val.dfs_apply(c.process)
            else:
                return False
    
        elif self.right:
            if self.right.find_nemo(name):
               
                return self.right.val.dfs_apply(c.process)
            else:
                return False
TreeNode.find_nemo = find_nemo
